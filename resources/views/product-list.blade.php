...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Sep 2025 11:53:24 GMT -->
...
<head>
    ...
    <script src="assets/js/theme-script.js" type="7b1286463099e604a22c940d-text/javascript"></script>
...
<body>
                    ...
                    <ul>
                        ...
                        <li class="submenu-open">
                            ...
                            <ul>
                                ...
                                <li><a href="account-list-2.html"><i
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        <a href="add-product.html" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>Add
                            Product</a>
                    </div>
                    <div class="page-btn import">
                        <a href="#" class="btn btn-secondary color" data-bs-toggle="modal"
                            data-bs-target="#view-notes"><i data-feather="download" class="me-1"></i>Import Product</a>
                    </div>
                </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>

    <!-- Feather Icon JS -->
    <script src="assets/js/feather.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>

    <!-- Slimscroll JS -->
    <script src="assets/js/jquery.slimscroll.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>

    <!-- Datatable JS -->
    <script src="assets/js/jquery.dataTables.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>
    <script src="assets/js/dataTables.bootstrap5.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>

    <!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>

    <!-- Datetimepicker JS -->
    <script src="assets/js/moment.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="7b1286463099e604a22c940d-text/javascript"></script>

    <!-- Bootstrap Tagsinput JS -->
    <script src="assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js"
        type="7b1286463099e604a22c940d-text/javascript"></script>

    <!-- Color Picker JS -->
    <script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="7b1286463099e604a22c940d-text/javascript">
    </script>

    <!-- Custom JS -->
    <script src="assets/js/theme-colorpicker.js" type="7b1286463099e604a22c940d-text/javascript"></script>
    <script src="assets/js/script.js" type="7b1286463099e604a22c940d-text/javascript"></script>

    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="7b1286463099e604a22c940d-|49" defer></script>
    <script defer
        src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ=="
        data-cf-beacon='{"rayId":"97e76733c9f7b7d1","version":"2025.8.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}'

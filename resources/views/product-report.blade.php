...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/product-report.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Sep 2025 11:57:54 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>
    ...
    <body>
					...
					<ul>
						...
						<li class="submenu-open">
							...
							<ul>
								...
								<li><a href="account-list-2.html"><i class="ti ti-building-bank fs-16 me-2"></i><span>Bank Accounts</span></a></li>
						...
						<li class="submenu-open">
							...
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="active subdrop"><i class="ti ti-report-analytics fs-16 me-2"></i><span>Product Report</span><span class="menu-arrow"></span></a>
									<ul>
										<li><a href="product-report.html" class="active">Product Report</a></li>
					...
					<ul class="nav-menu">
						...
						<li class="submenu">
							...
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="active subdrop"><span>Product Report</span><span class="menu-arrow"></span></a>
									<ul>
										<li><a href="product-report.html" class="active">Product Report</a></li>
										<li><a href="product-expiry-report.html">Product Expiry Report</a></li>
										<li><a href="product-quantity-alert.html">Product Quantity Alert</a></li>
					...
					<!-- /Logo -->
						<div class="sidebar-scroll">
							...
							<div class="tab-content" id="v-pills-tabContent">
								...
								<div class="tab-pane fade active show" id="reports">
									<ul>
				...
				<div class="content">
					<div class="mb-4">
						<ul class="nav nav-pills">
							<li class="nav-item">
								<a class="nav-link active" href="product-report.html">Product Report</a>
							</li>
							<li class="nav-item">
							  	<a class="nav-link" href="product-expiry-report.html">Product Expiry Report</a>
							</li>
							<li class="nav-item">
							  	<a class="nav-link" href="product-quantity-alert.html">Product Quantity Alert</a>
							</li>
						</ul>
					</div>
					<div>
						...
						<div class="card">
							<div class="card-body pb-1">
								<form action="https://dreamspos.dreamstechnologies.com/html/template/product-report.html">
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="assets/js/jquery.dataTables.min.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>
		<script src="assets/js/dataTables.bootstrap5.min.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>

		<!-- Daterangepikcer JS -->
		<script src="assets/js/moment.min.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>
		<script src="assets/plugins/daterangepicker/daterangepicker.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>
		<script src="assets/js/script.js" type="018bfa629d13bbc8ac88b7db-text/javascript"></script>
		
	
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="018bfa629d13bbc8ac88b7db-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"97e768d7680b3292","version":"2025.8.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

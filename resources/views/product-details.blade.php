...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Sep 2025 12:01:14 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="26d017669251029981183742-text/javascript"></script>
    ...
    <body>
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="26d017669251029981183742-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="26d017669251029981183742-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="26d017669251029981183742-text/javascript"></script>

		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="26d017669251029981183742-text/javascript"></script>

		<!-- Owl JS -->
		<script src="assets/plugins/owlcarousel/owl.carousel.min.js" type="26d017669251029981183742-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="26d017669251029981183742-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="26d017669251029981183742-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="26d017669251029981183742-text/javascript"></script>
		<script src="assets/js/script.js" type="26d017669251029981183742-text/javascript"></script>

	
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="26d017669251029981183742-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"97e76fddcb1a3292","version":"2025.8.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Sep 2025 12:01:18 GMT -->
</html>